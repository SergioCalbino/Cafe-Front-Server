...
const Product = (product) => {
  ...
  return (
    ...
    <div className='px-4 py-2'>
      ...
      <p className='text-gray-800 font-bold text-xl mb-1'>{product.nombre}</p>
    ...
    <div className='px-4 py-2'>
      ...
      <p className='text-gray-600'>Precio: <span className='text-gray-800 font-bold'>$ {product.precio}</span></p>
      <p className='text-gray-600'>Disponibilidad: <span className='text-gray-800 font-bold'>{product.disponible ? 'Si' : 'No'}</span></p>
    </div>
  </div>
